...
namespace AssetManagement.Data.Migrations
{
    ...
    [Migration("20250611070307_AddHistoryPassword")]
    partial class AddHistoryPassword
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssetManagement.Domain.Entities.User", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("HistoryPasswords")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AssetManagement.Domain.Entities.ReturnRequest", b =>
                {
                    b.HasOne("AssetManagement.Domain.Entities.User", "Acceptor")
                        .WithMany()
                    ...
                    b.HasOne("AssetManagement.Domain.Entities.User", "Requester")
                        .WithMany()
